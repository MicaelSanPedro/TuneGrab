...
class PlaybackService : Service() {
    ...
    private val playerListener = object : Player.Listener {
        ...
        override fun onIsPlayingChanged(isPlaying: Boolean) {
            // PAUSA = O ESPECTRO DORME (v0.19.18, bug do autor: "quando eu
            // pauso uma música, depois que o espectro baixa, ele acorda, e
            // desce denovo"): o sink do ExoPlayer ainda aceita PCM por um
            // instante depois da pausa (top-off do buffer) e o processador
            // publicava esse fluxo — as barrinhas subiam de novo DEPOIS de
            // caídas. Cobrindo AQUI (e não no pause()), qualquer pausa dorme
            // o espectro: botão do player, notificação, cartão de mídia,
            // fone e perda de foco de áudio. Tocou de novo? Acorda junto.
            spectrum.setSpectrumPaused(!isPlaying)
